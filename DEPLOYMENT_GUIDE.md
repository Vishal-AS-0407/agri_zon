# 🚀 Agrizon Deployment Guide

This guide will help you deploy your Agrizon application for free using Render (backend) and Vercel (frontend).
...
- **Name:** `agrizon-backend` (or any name you prefer)
...
3. You'll get a URL like: `https://agrizon-backend.onrender.com`
### Step 7: Test Your Backend

Visit: `
https://agrizon-mvp.onrender.com`

You should see:
```json
{
  "message": "Agrizon Field Analysis API",
  "version": "1.0.0",
  "status": "running"
}
```
