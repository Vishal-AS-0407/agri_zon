...
"""
        ...
        prompt = f"""You are an expert Agronomist Advisor specializing in Tamil Nadu and Kerala farming systems.
...
1. SOIL INFERENCE: Based on coordinates {lat_lon}, infer the likely soil characteristics specific to this region of TN/KL
...
- Use realistic TN/KL yields and current market prices
...
"""
    ...
    def _get_fallback_recommendations(self, field_data: Dict[str, Any]) -> List[Dict[str, Any]]:
        ...
        # Default recommendations for TN/KL region
        recommendations = [
            {
                "crop": "Rice (Paddy)",
                "confidence": 85,
            ...
            },
            {
                ...
                "season": current_season,
                "reasoning": "Performs well in TN/KL with moderate water needs. Strong market demand."
            },
            {
                "crop": "Maize",
                "confidence": 70,
