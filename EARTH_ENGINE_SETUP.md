...
3. Fill in the details:
   - **Service account name:** `agrizon-earth-engine`
   - **Service account ID:** (auto-generated)
   - **Description:** "Service account for Agrizon Earth Engine access"
...
```json
{
  ...
  "client_email": "agrizon-earth-engine@nurture-sync.iam.gserviceaccount.com",
  "client_id": "123456789...",
...
5. Grant Earth Engine access to your service account email:
   - Email: `agrizon-earth-engine@nurture-sync.iam.gserviceaccount.com`
...
2. Check the logs - you should see:
   ```
   ✅ Earth Engine initialized with service account: agrizon-earth-engine@nurture-sync.iam.gserviceaccount.com
   ```
