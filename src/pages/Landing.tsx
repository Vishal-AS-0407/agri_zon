  ...
  const testimonials = [
    {
      ...
      location: "Tamil Nadu",
      rating: 5,
      comment: "Agrizon helped me increase my crop yield by 35% with their precise land analysis."
    },
    {
      name: "Priya Sharma",
      location: "Kerala",
      ...
      <section className="py-20 bg-muted/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground">
              See how Agrizon is transforming agricultural practices
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-hero">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-primary-foreground/90 mb-8">
            Join thousands of farmers who are already using Agrizon to optimize their land and increase profits.
          </p>
